...
class RSpec::Mocks::Proxy
  ...
  def initialize(object, order_group, name = nil, options = nil); end
...
class RSpec::Mocks::TargetBase
  ...
  def self.delegate_not_to(matcher_method, options = nil); end
  def self.delegate_to(matcher_method); end
  def self.disallow_negation(method_name); end
end
