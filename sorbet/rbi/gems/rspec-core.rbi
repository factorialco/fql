...
class RSpec::Core::Hooks::BaseHookCollection
  ...
  def pop(*a, &b); end
  def prepend(*a, &b); end
  def pretty_print(*a, &b); end
  def pretty_print_cycle(*a, &b); end
  def product(*a, &b); end
  def push(*a, &b); end
  def rassoc(*a, &b); end
  def reject!(*a, &b); end
...
module RSpec::Core::MetadataFilter
  def self.all_apply?(filters, metadata); end
  def self.any_apply?(filters, metadata); end
  def self.example_group_declaration_line(locations, metadata); end
  ...
  def self.line_number_filter_applies?(line_numbers, metadata); end
  def self.location_filter_applies?(locations, metadata); end
  def self.parent_of(metadata); end
  def self.relevant_line_numbers(metadata); end
...
class RSpec::Core::SuiteHookContext < RSpec::Core::Example
  def initialize; end
  def set_exception(exception, _context = nil); end
end
